...
const Project = (project: ProjectData) => {
    ...
    return (
        <motion.div
            ...
            <div className="bg-slate-100 max-w-[50rem] border border-black/5 rounded-lg overflow-hidden sm:pr-8 relative h-full hover:bg-slate-200 transition sm:group-even:pl-3">
            ...
            "
                    ...
                    <SkillTagList tags={project.skills} />
                </div>
